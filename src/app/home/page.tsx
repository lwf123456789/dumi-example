...
const Messages: React.FC = () => {
  const messages = [
    { sender: "丽莎·王", message: "你用过Node.js开发过后台吗？", time: "5:00pm", self: false },
    { sender: "自己", message: "是的，我用Node.js做过几个项目。", time: "5:02pm", self: true },
    { sender: "丽莎·王", message: "太好了，我正准备开始一个新的Node.js项目。", time: "5:03pm", self: false },
    { sender: "自己", message: "是的，我用Node.js做过几个项目。", time: "5:02pm", self: true },
    { sender: "丽莎·王", message: "你用过Node.js开发过后台吗？", time: "5:00pm", self: false },
    { sender: "自己", message: "是的，我用Node.js做过几个项目。", time: "5:02pm", self: true },
    { sender: "丽莎·王", message: "你用过Node.js开发过后台吗？", time: "5:00pm", self: false },
  ...
  return (
    <>
      <div className="h-[calc(100vh-186px)] overflow-hidden sm:h-[calc(100vh-174px)]">
        <div className="h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark flex flex-col">
            ...
            <div className="sticky flex items-center justify-between border-b border-stroke px-6 py-4.5 dark:border-strokedark">
              <div className="flex items-center">
                <div className="mr-4.5 h-13 w-full max-w-13 overflow-hidden rounded-full">
                  <Image
                    src="https://cdn-icons-png.flaticon.com/128/6214/6214046.png"
                    alt="avatar"
                ...
                <div>
                  ...
                  <p className="text-sm">回复消息</p>
                </div>
              </div>
            </div>
            <div className="no-scrollbar h-full space-y-3.5 overflow-auto px-6 py-7.5">
